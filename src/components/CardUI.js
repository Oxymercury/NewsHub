    ...
    <div className="bg-white">
      <div className="my-2 py-2 bg-white sm:mx-4">
        <img
          ...
          className="rounded-t-md sm:rounded-md w-full"
        />
        <p className="mx-3 font-bold text-sm my-3 text-[#343A40]">
          {props.CardTitle}
        </p>
        <div className="mx-4 flex justify-between items-center my-2">
          <p className="font-bold w-5/6">{props.Heading}</p>
          <div onClick={ChangeToggle} className="relative ">
            <div className="cursor-pointer">
              <MoreHorizIcon />
            </div>
            {showOption && (<div className="absolute opacity-100 transition-opacity duration-300 bg-slate-200 z-10 text-white rounded-lg p-1 top-6 right-0">
        ...
        <p className="mx-4 text-sm text-[#5C5C5C] my-3">{props.description}</p>
        <div className="flex justify-between items-center mx-4 my-2">
          <div className="flex justify-start items-center ">
            <img src={props.image} className="h-9  mr-4" />
            <div>
              <p className="text-sm font-bold">{props.person}</p>
          ...
          <div className="flex justify-end items-center">
            <p className="text-sm text-[#525252] font-medium hidden xl:block mx-6">
              {props.view}
            </p>
            <button
              onClick={ShareToggle}
